(function () {
  ...
  function createStyles() {
    ...
    style.textContent = [
      ...
      "#cw-mic:hover{border-color:#6366f1}",
      ...
      "#cw-lang-toggle button.active{background:#6366f1;color:#fff}",
      ...
      "#cw-speak-toggle.active{background:#eef2ff;border-color:#6366f1;color:#6366f1}",
