  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        ...
        {/* Table header */}
        <div className="grid grid-cols-[70px_60px_minmax(140px,2fr)_minmax(100px,1fr)_100px_110px_110px_120px_80px_44px] gap-0 border-b border-border bg-muted/30 px-4 py-3 min-w-[960px]">
        ...
        {isLoading ? (
          <div className="divide-y divide-border min-w-[1060px]">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="grid grid-cols-[70px_60px_minmax(140px,2fr)_minmax(100px,1fr)_100px_110px_110px_120px_80px_44px] gap-0 px-4 py-4 items-center">
          ...
          <div className="divide-y divide-border min-w-[1060px]">
            {filtered.map((company) => {
              ...
              return (
                <div
                  key={company.id}
                  className="group grid grid-cols-[70px_60px_minmax(140px,2fr)_minmax(100px,1fr)_100px_110px_110px_120px_80px_44px] gap-0 px-4 py-3.5 items-center hover:bg-muted/20 transition-colors"
                >
                  {/* My ID */}
                  <div className="px-2">
