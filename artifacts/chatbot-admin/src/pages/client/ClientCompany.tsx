...
const AI_PROVIDERS = {
  ...
  google: {
    ...
    models: [
      ...
      { value: "gemini-3.1-pro", label: "Gemini 3.1 Pro", free: false },
      { value: "gemini-3.1-flash-lite", label: "Gemini 3.1 Flash-Lite", free: false },
      { value: "gemini-3.5-flash-lite", label: "Gemini 3.5 Flash-Lite", free: false },
    ],
  },
  openrouter: {
    label: "OpenRouter",
